...
insert into homework (homework_id, created_at, modified_at, content, end_time, homework_name, start_time, book_id, lesson_id)
values (8, now(), now(), 'p 0 ~ 10', now() + INTERVAL 1 MONTH, '수학 정석2', now(), 2, 2);

insert into homework (homework_id, created_at, modified_at, content, end_time, homework_name, start_time, book_id, lesson_id)
values (9, now(), now(), 'p 100 ~ 110', now() + INTERVAL 1 MONTH, '수학 정석2', now(), 2, 2);

insert into homework (homework_id, created_at, modified_at, content, end_time, homework_name, start_time, book_id, lesson_id)
values (10, now(), now(), 'p 0 ~ 10', now() + INTERVAL 1 MONTH, '물리 숙제', now(), 3, 4);

insert into homework (homework_id, created_at, modified_at, content, end_time, homework_name, start_time, book_id, lesson_id)
values (11, now(), now(), 'p 0 ~ 10', now() + INTERVAL 1 MONTH, '물리2 숙제', now(), 4, 5);

insert into homework (homework_id, created_at, modified_at, content, end_time, homework_name, start_time, book_id, lesson_id)
values (12, now(), now(), 'p 100 ~ 110', now() + INTERVAL 1 MONTH, '수학 정석1', now(), 1, 1);
