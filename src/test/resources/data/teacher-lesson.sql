...
insert into lesson values (1, now(), now(), 'MONDAY,TUESDAY,WEDNESDAY,THURSDAY,SATURDAY', '13:00:00', '수학', '12:00:00',1);
...
insert into lesson values (5, now(), now(), 'FRIDAY', now(), '수학2', now(),2);
